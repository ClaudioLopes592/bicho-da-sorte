...
const TernoDezena = () => {
  ...
  const [tdezena, setTDezena] = useState('');
  ...
  function gerarDezena(min, max) {
      ...
      const tnum = Math.floor(Math.random() * (max - min)) + min;
      setPDezena(pnum);
      setSDezena(snum);
      setTDezena(tnum);
  }
  ...
  return (
    ...
    <View style={styles.container} >
            ...
            >
            <Text style={styles.titulo}>TERNO DE DEZENA</Text>
            ...
            <View>
                ...
                {avestruz.includes(tdezena) ? 
                <Imagem 
                texto="AVESTRUZ"
                img={require("../../Img/avestruz.jpg")} />
                : aguia.includes(tdezena) ? 
                <Imagem 
                texto="ÁGUIA"
                img={require("../../Img/aguia.jpg")} />
                : burro.includes(tdezena) ? 
                <Imagem 
                texto="BURRO"
                img={require("../../Img/burro.jpg")} />
                : borboleta.includes(tdezena) ? 
                <Imagem 
                texto="BORBOLETA"
                img={require("../../Img/borboleta.jpg")} />
                : cachorro.includes(tdezena) ? 
                <Imagem 
                texto="CACHORRO"
                img={require("../../Img/cachorro.jpg")} />
                : cabra.includes(tdezena) ? 
                <Imagem 
                texto="CABRA"
                img={require("../../Img/cabra.jpg")} />
                : carneiro.includes(tdezena) ? 
                <Imagem 
                texto="CARNEIRO"
                img={require("../../Img/carneiro.jpg")} />
                : camelo.includes(tdezena) ? 
                <Imagem 
                texto="CAMELO"
                img={require("../../Img/camelo.jpg")} />
                : cobra.includes(tdezena) ? 
                <Imagem 
                texto="COBRA"
                img={require("../../Img/cobra.jpg")} />
                : coelho.includes(tdezena) ? 
                <Imagem 
                texto="COELHO"
                img={require("../../Img/coelho.jpg")} />
                : cavalo.includes(tdezena) ? 
                <Imagem 
                texto="CAVALO"
                img={require("../../Img/cavalo.jpg")} />
                : elefante.includes(tdezena) ? 
                <Imagem 
                texto="ELEFANTE"
                img={require("../../Img/elefante.jpg")} />
                : galo.includes(tdezena) ? 
                <Imagem 
                texto="GALO"
                img={require("../../Img/galo.jpg")} />
                : gato.includes(tdezena) ? 
                <Imagem 
                texto="GATO"
                img={require("../../Img/gato.jpg")} />
                : jacare.includes(tdezena) ? 
                <Imagem 
                texto="JACARÉ"
                img={require("../../Img/jacare.jpg")} />
                : leao.includes(tdezena) ? 
                <Imagem 
                texto="LEÃO"
                img={require("../../Img/leao.jpg")} />
                : macaco.includes(tdezena) ? 
                <Imagem 
                texto="MACACO"
                img={require("../../Img/macaco.jpg")} />
                : porco.includes(tdezena) ? 
                <Imagem 
                texto="PORCO"
                img={require("../../Img/porco.jpg")} />
                : pavao.includes(tdezena) ? 
                <Imagem 
                texto="PAVÃO"
                img={require("../../Img/pavao.jpg")} />
                : peru.includes(tdezena) ? 
                <Imagem 
                texto="PERU"
                img={require("../../Img/peru.jpg")} />
                : touro.includes(tdezena) ? 
                <Imagem 
                texto="TOURO"
                img={require("../../Img/touro.jpg")} />
                : tigre.includes(tdezena) ? 
                <Imagem 
                texto="TIGRE"
                img={require("../../Img/tigre.jpg")} />
                : urso.includes(tdezena) ? 
                <Imagem 
                texto="URSO"
                img={require("../../Img/urso.jpg")} />
                : veado.includes(tdezena) ? 
                <Imagem 
                texto="VEADO"
                img={require("../../Img/veado.jpg")} />
                : vaca.includes(tdezena) ? 
                <Imagem 
                texto="VACA"
                img={require("../../Img/vaca.jpg")} />
                : null }
                {
                    tdezena === "" ? <Text></Text> : 
                    tdezena <= 9 ?
                        <Text style={styles.dezenas} >{'0' + tdezena}</Text>
                        :
                        <Text style={styles.dezenas} >{tdezena}</Text>
                }
            </View>
            <View>
