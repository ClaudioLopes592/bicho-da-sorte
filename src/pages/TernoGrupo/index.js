...
const DuqueGrupo = () => {
  ...
  return (
    ...
    <View style={styles.container} >
      ...
      >
        <Text style={styles.titulo}>TERNO DE GRUPO</Text>
        <View style={styles.containerBotao} >
          ...
          <View>
            {tgrupo === "" ? <Text></Text> : <Text style={styles.dezenas} >{tgrupo + 1}</Text>}
          </View>
        </View>
        <View>
